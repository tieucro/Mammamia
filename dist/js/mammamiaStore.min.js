var mammamiaStore = {
    products: [],
    plugins: {},
    settings: { numColumns: 3, brand: "mammamiaStore", mode: "JSON", JSONFile: "products.json", fadeSpeed: 200, buttonColor: null, backgroundColor: null, textColor: null, container: $(".mammamiaStore_container"), cartContainer: $(".mammamiaStore_cart_container"), rowClass: "mammamiaStore_row_", columnWidthClasses: { 1: "", 2: "one-half", 3: "one-third" } },
